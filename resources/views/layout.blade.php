...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('frontend/css/custom.css') }}?v={{ @filemtime(public_path('frontend/css/custom.css')) ?: time() }}">
   ...
   @if(Session::get('lang_dir') == 'right_to_left')
    ...
    <style>
        ...
        .listing-call-btn:hover{
            color: #0CA640;
            background: rgba(12, 166, 64, 0.06);
        }
        ...
        .listing-list-price-bottom-right{
            position: absolute;
            right: 40px;
            bottom: 25px;
            display: flex;
    ...
    @if ($google_analytic && $google_analytic->status == 1)
        <script async src="https://www.googletagmanager.com/gtag/js?id={{ $google_analytic ? $google_analytic->analytic_id : '' }}"></script>
        <script>
            window.dataLayer = window.dataLayer || [];
            function gtag(){dataLayer.push(arguments);}
            gtag('js', new Date());
            gtag('config', '{{ $google_analytic ? $google_analytic->analytic_id : '' }}');
        </script>
    @endif
...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12 col-p-0">
                        <div class="nav-main">
                            ...
                            <div class="header-two-nav-right">
                                <div class="menu">
                                    <ul>
                                        
                                        <li>
                                            <a href="javascript:;">{{ __('Search Ad') }} <i class="fa-solid fa-angle-down"></i> </a>
                                            <ul class="sub-menu">
                                                <li><a href="{{ route('listings') }}">Search Car</a></li>
                                                <li><a href="{{ route('car-parts') }}">Search Part</a></li>
                                                <li><a href="{{ route('home') }}">Home / Search</a></li>
                                            </ul>
                                        </li>
                                        <li><a href="{{ route('car-part-requests.index') }}">Part HELP</a></li>
                                ...
                                @if ($setting && $setting->add_listing == 'enable')
                                    ...
                                    @if (Route::is('home'))
                                        @if (Session::get('selected_theme') == 'theme_one')
                                            <a href="{{ route('user.select-car-purpose') }}" class="thm-btn-two">Place Ad</a>
                                        @elseif (Session::get('selected_theme') == 'theme_two')
                                            <a href="{{ route('user.select-car-purpose') }}" class="thm-btn-thr">Place Ad</a>
                                        @elseif (Session::get('selected_theme') == 'theme_three')
                                            <a href="{{ route('user.select-car-purpose') }}" class="thm-btn">Place Ad</a>
                                        @endif
    ...
    <aside id="offcanvas-nav" >
        ...
        {{ Session::get('selected_theme') == 'theme_two' ? 'm-nav-two' : '' }} {{ Session::get('selected_theme') == 'theme_three' ? 'm-nav-three' : '' }} @endif ">
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    <a href="javascript:;">{{ __('Search AD') }}
                        <span>
                    ...
                    <ul class="d-menu">
                        <li><a href="{{ route('listings') }}">Search Car</a></li>
                        <li><a href="{{ route('car-parts') }}">Search Part</a></li>
                        <li><a href="{{ route('home') }}">Car & Part Search</a></li>
                    </ul>
                </li>
                <li><a href="{{ route('car-part-requests.index') }}">Part HELP</a></li>
                <li><a href="{{ route('dealers') }}">{{ __('translate.Dealers') }}</a></li>
    ...
    @if (!Route::is('home'))
        <div class="d-block d-md-none">
            <div class="lp-mobile__header">
                <div class="lp-mobile__logo">
                    <a href="{{ route('home') }}" style="text-decoration:none;">
                        <img src="{{ asset('frontend/assets/images/logo/car-n-part.png') }}" alt="logo">
                    </a>
                </div>

                <div class="lp-mobile__nav">
                    ...
                    <div class="lp-mobile__nav-right">
                        ...
                        <button class="lp-mobile__menu" type="button" aria-label="menu" data-bs-toggle="offcanvas" data-bs-target="#lpMobileMenu" aria-controls="lpMobileMenu">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="lpMobileMenu" aria-labelledby="lpMobileMenuLabel">
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="lpMobileMenuLabel">Menu</h5>
                ...
                @auth('web')
                    <div class="offcanvas offcanvas-start" tabindex="-1" id="lpMobileMyAds" aria-labelledby="lpMobileMyAdsLabel">
                        <div class="offcanvas-header">
                            <h5 class="offcanvas-title" id="lpMobileMyAdsLabel">My Ads</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                        </div>
                        <div class="offcanvas-body">
                            @php
                                $lpMobileMyAdsCarCount = \Modules\Car\Entities\Car::where('agent_id', auth('web')->id())->count();
                            ...
                            <div class="d-grid gap-2">
                                ...
                                @if($__canSellVehicle)
                                    <a class="btn btn-light text-start d-flex justify-content-between align-items-center" href="{{ route('user.car.index') }}">
                                        ...
                                        <span>{{ $lpMobileMyAdsCarCount }}</span>
                                    </a>
                                @endif
                                @if($__canSellPart)
                                    <a class="btn btn-light text-start d-flex justify-content-between align-items-center" href="{{ route('user.car-part.index') }}">
                                        ...
                                        <span>{{ $lpMobileMyAdsCarPartCount }}</span>
                                    </a>
                                @endif
    ...
    @if (false && $tawk_chat && $tawk_chat->status == 1)
        <script type="text/javascript">
            var Tawk_API=Tawk_API||{}, Tawk_LoadStart=new Date();
            (function(){
                var s1=document.createElement("script"),s0=document.getElementsByTagName("script")[0];
                s1.async=true;
                s1.src='{{ $tawk_chat ? $tawk_chat->chat_link : '' }}';
                s1.charset='UTF-8';
    ...
    <footer class="footer {{ Session::get('selected_theme') == 'theme_two' ? 'footer-three' : ''  }} {{ Session::get('selected_theme') == 'theme_one' ? 'footer-two' : ''  }}" style="display:none;">
            ...
            <div class="row footer-mt-75px   ">
                <div class=" col-xl-4 col-lg-6 col-md-12 " data-aos="fade-right" data-aos-delay="100">
                    ...
                    <div class="footer-text-p">
                        <p>{{ $setting ? $setting->about_us : 'Welcome to our car marketplace platform' }}</p>
                    </div>
                    ...
                    <div class="row footer-ml">
                        <div class="col-xl-4 col-lg-4 col-sm-6 col-md-4" data-aos="fade-up" data-aos-delay="200">
                            ...
                            @else
                                <ul>
                                    <li>
                                        <a href="mailto:{{ $setting ? $setting->email : 'info@carbaz.com' }}">
                                            <span>
                                                <svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M1 4L9.93142 9.91715C10.5623 10.3452 11.4377 10.3452 12.0686 9.91715L21 4M2 1H20C20.5523 1 21 1.44772 21 2V18C21 18.5523 20.5523 19 20 19H2C1.44772 19 1 18.5523 1 18V2C1 1.44772 1.44772 1 2 1Z"/>
                                                    </svg>
                                            </span>
                                            {{ $setting ? $setting->email : 'info@carbaz.com' }}
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="col-xl-4 col-lg-4   col-sm-6 col-md-3" data-aos="fade-up" data-aos-delay="400">
                            ...
                            <div class="footer-item-text-link two">
                                ...
                                <ul>
                                    <li>
                                        <a href="tel:{{ $setting ? $setting->phone : '+1234567890' }}">
                                            <span>
                                            ...
                                            {{ $setting ? $setting->phone : '+1234567890' }}
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="javascript:;">
                                            ...
                                            {{ $setting ? $setting->address : '123 Main Street, City, Country' }}
                                        </a>
                                    </li>
                                </ul>
    ...
    <script>
        ...
        var cookieChoice = localStorage.getItem('car-listo-cookie');
        if (cookieChoice == '1') {
            cookieChoice = 'all';
            localStorage.setItem('car-listo-cookie', 'all');
        }
