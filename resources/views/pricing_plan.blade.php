                        ...
                        @if(($setting?->fee_free_mode == 'enable') && Auth::guard('web')->check() && Auth::guard('web')->user()?->is_dealer)
                            <div class="col-lg-4">
                                <div class="pricing-item pricing-item-two">
                                    ...
                                    <h4 class="pricing-text">{{ __('3 Month Free Trial') }}</h4>
                                    <h2 class="pricing-text-box">
                                        {{ __('Free') }}
                                        <span>/{{ __('translate.Monthly') }}</span>
                                    </h2>
                                    ...
                                    <div class="pricing-item-box">
                                        <ul>
                                            <li>
                                                ...
                                                {{ __('translate.Duration') }} : {{ __('translate.Monthly') }}
                                            </li>
                                            <li>
                                                <span>
                                                    <svg width="14" height="10" viewBox="0 0 14 10" fill="none"
                                            ...
                                            <li>
                                                ...
                                                {{ __('translate.Number of Featured') }} : 0
                                            </li>
                                    ...
                                    <form action="{{ route('activate-dealer-free-trial') }}" method="POST">
                                        @csrf
                                        <button type="submit" class="thm-btn-two">{{ __('Activate') }}</button>
                                    </form>
