@extends('layout')
@section('title')
    <title>{{ $seo_setting ? $seo_setting->seo_title : 'Carbaz Marketplace' }}</title>
    <meta name="title" content="{{ $seo_setting ? $seo_setting->seo_title : 'Carbaz Marketplace' }}">
    <meta name="description" content="{!! $seo_setting ? strip_tags(clean($seo_setting->seo_description)) : 'Best car marketplace' !!}">
@endsection
...
@section('body-content')
    <main>
        ...
        <section class="banner-two"
            style="background-image: url({{ getImageOrPlaceholder($homepage ? $homepage->home1_intro_bg : null, '1904x1031') }})">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="banner-two-txt">
                            <span>{{ $homepage ? $homepage->home1_intro_short_title : 'Welcome' }}</span>
                            <h1>{{ $homepage ? $homepage->home1_intro_title : 'Carbaz Marketplace' }}</h1>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="banner-car">
                            <div class="banner-car-thumb">
                                <img src="{{ getImageOrPlaceholder($homepage ? $homepage->home1_intro_image : null, '1408x525') }}"
                                    alt="thumb">
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="container">
                        <div class="row align-items-end">
                            <div class="col-lg-6 col-sm-6  col-md-6">
                                <div class="taitel two">
                                    ...
                                    <span>{{ __('translate.Car Parts') }}</span>
                                </div>

                                <h2>{{ __('translate.Latest Car Parts') }}</h2>
                            </div>
                        </div>

                        <div class="row mt-60px g-5">
                            @foreach ($car_parts as $part)
                                <div class="col-lg-6  col-sm-12 ">
                                    <div class="brand-car-item">
                                        <div class="brand-car-item-img">
                                            <img src="{{ getImageOrPlaceholder($part->thumb_image, '329x203') }}" alt="thumb">

                                            <div class="brand-car-item-img-text">
                                                <div class="text-df">
                                                    @if ($part->offer_price)
                                                        <p class="text">
                                                            {{ calculate_percentage($part->regular_price, $part->offer_price) }}
                                                            % {{ __('translate.Off') }}</p>
                                                    @endif
                        ...
                        <div class="row mt-60px">
                            <div class="col-12 text-center">
                                <a class="thm-btn-two" href="{{ route('car-parts') }}">{{ __('translate.View More') }}</a>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section class="vedio vedio-two ">
                    <div class="container vedio-bg"
                        style="background: url({{ getImageOrPlaceholder($homepage ? $homepage->video_bg_image : null, '1440x531') }})">
                        <div class="row align-items-center">
                            <div class="col-lg-6 col-sm-6 ">
                                <div class="taitel two">
                                    ...
                                    <span>
                                        {{ $homepage ? $homepage->video_short_title : 'Video Title' }}
                                    </span>
                                </div>

                                <h2 class="vedio-taitel">{{ $homepage ? $homepage->video_title : 'Video Title' }}</h2>
                                <div class="vedio-btn">
                            ...
                            <div class="col-lg-6 col-sm-6 ">
                                <div class="vedio-item">
                                    <a class="my-video-links" data-autoplay="true" data-vbtype="video"
                                        href="https://youtu.be/{{ $homepage ? $homepage->video_id : 'dQw4w9WgXcQ' }}">
                ...
                <section class="feature-two py-120px ">
                    ...
                    <div class="container">
                        ...
                        <div class="row g-5 mt-32px ">
                            @if ($home1_ads && $home1_ads->status == 'enable')
                                <div class=" col-xl-6 col-lg-8">
                                    <div class="feature-two-img-main">
                                        <div class="feature-two-img">
                                            <a href="{{ $home1_ads ? $home1_ads->link : '#' }}"><img
                                                    src="{{ getImageOrPlaceholder($home1_ads ? $home1_ads->image : null, '690x460') }}"
                                                    alt="thumb"></a>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <section class="home-forum" data-aos="fade-up" data-aos-duration="1000">
                        <div class="container">
                            <div class="home-forum__header">
                                <h2 class="home-forum__title">News, Reviews &amp; Discussions</h2>
                                <a class="home-forum__all" href="{{ route('blogs') }}">Read All Recent News</a>
                            </div>

                            <div class="home-forum__tabs">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="home-forum-news-tab" data-bs-toggle="tab" data-bs-target="#home-forum-news" type="button" role="tab" aria-controls="home-forum-news" aria-selected="true">Automotive News</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="home-forum-reviews-tab" data-bs-toggle="tab" data-bs-target="#home-forum-reviews" type="button" role="tab" aria-controls="home-forum-reviews" aria-selected="false">Car Reviews</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="home-forum-discussions-tab" data-bs-toggle="tab" data-bs-target="#home-forum-discussions" type="button" role="tab" aria-controls="home-forum-discussions" aria-selected="false">Discussions</button>
                                    </li>
                                </ul>
                            </div>

                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="home-forum-news" role="tabpanel" aria-labelledby="home-forum-news-tab">
                                    <div class="home-forum__list">
                                        @foreach($forum_news as $item)
                                            <a class="home-forum__item" href="{{ route('blog', $item->slug) }}">
                                                <div class="home-forum__thumb">
                                                    <img src="{{ getImageOrPlaceholder($item->image, '120x90') }}" alt="thumb">
                                                </div>
                                                <div class="home-forum__body">
                                                    <div class="home-forum__item-title">{{ $item->title }}</div>
                                                    <div class="home-forum__item-meta">{{ $item->created_at ? $item->created_at->format('F d, Y') : '' }}</div>
                                                </div>
                                            </a>
                                        @endforeach
                                    </div>
                                ...
                                <div class="tab-pane fade" id="home-forum-reviews" role="tabpanel" aria-labelledby="home-forum-reviews-tab">
                                    <div class="home-forum__list">
                                        @foreach($forum_reviews as $item)
                                            <a class="home-forum__item" href="{{ route('blog', $item->slug) }}">
                                                <div class="home-forum__thumb">
                                                    <img src="{{ getImageOrPlaceholder($item->image, '120x90') }}" alt="thumb">
                                                </div>
                                ...
                                <div class="tab-pane fade" id="home-forum-discussions" role="tabpanel" aria-labelledby="home-forum-discussions-tab">
                                    <div class="home-forum__list">
                                        @foreach($forum_discussions as $discussion)
                                            <a class="home-forum__item" href="{{ route('car-part-requests.show', $discussion->id) }}">
                                                <div class="home-forum__thumb home-forum__thumb--text">{{ strtoupper(substr($discussion->title ?? 'D', 0, 1)) }}</div>
                                                <div class="home-forum__body">
                                                    <div class="home-forum__item-title">{{ $discussion->title }}</div>
                                                    <div class="home-forum__item-meta">{{ $discussion->created_at ? $discussion->created_at->format('F d, Y') : '' }}</div>
                                                </div>
                                            </a>
                                        @endforeach
