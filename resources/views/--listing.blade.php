                                    ...
                                    <div class=" col-xxl-12  col-xl-12  col-lg-12  col-sm-12 ">
                                        <div class="listing-list-card">
                                            <div class="listing-list-media">
                                                ...
                                                <img class="listing-list-watermark" src="{{ asset('frontend/assets/images/logo/auto-sales-logo.png') }}" alt="logo">
                                            </div>

                                            <div class="listing-list-content">
                                                @php
                                                    $dealer = $car?->dealer;
                                                    $sellerType = strtolower((string) ($car->seller_type ?? ''));
                                                    if ($sellerType !== '') {
                                                        $isDealer = str_contains($sellerType, 'dealer');
                                                    } else {
                                                        $isDealer = ((int) ($dealer?->is_dealer ?? 0)) === 1;
                                                    }
                                                    ...
                                                    if ($nctDate) {
                                                        try {
                                                            $nctText = 'Nct ' . strtolower(\Carbon\Carbon::parse($nctDate)->format('M Y'));
                                                        } catch (\Throwable $e) {
                                                    ...
                                                    $subtitleText = '';
                                                    if (!empty($car->motorcheck_model)) {
                                                        $subtitleText = (string) $car->motorcheck_model;
                                                    }
                                                @endphp

                                                <div class="listing-list-header">
                                                    <a href="{{ route('listing', $car->slug) }}" class="listing-list-title">
                                                        {{ $titleText !== '' ? $titleText : html_decode($car->title) }}
                                                    </a>

                                                    @php
                                                        $sellerPhone = preg_replace('/\s+/', '', (string) ($dealer?->phone ?? ''));
                                                    @endphp
                                                    @if ($sellerPhone)
                                                ...
                                                <div class="listing-list-body">
                                                    <div class="listing-list-details">
                                                        @if ($subtitleText !== '')
                                                            <div class="listing-list-detail">{{ html_decode($subtitleText) }}</div>
                                                        @endif

                                                        @if ($saleYear)
                                                            <div class="listing-list-detail">{{ $saleYear }}</div>
                                                        @endif

                                                        @if (!empty($car->motorcheck_fuel))
                                                            <div class="listing-list-detail">{{ html_decode($car->motorcheck_fuel) }}</div>
                                                        @elseif (!empty($car->fuel_type))
                                                            <div class="listing-list-detail">{{ html_decode($car->fuel_type) }}</div>
                                                        @endif

                                                        @if (!empty($car->mileage))
                                                            <div class="listing-list-detail">{{ html_decode($car->mileage) }}</div>
                                                        @endif

                                                        @if ($nctText)
                                                            <div class="listing-list-detail">{{ $nctText }}</div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="listing-list-pricecol">
                                                        ...
                                                        @if ($isDealer)
                                                            <div class="listing-price-meta">
                                                                <span class="dealer-tag">{{ __('translate.Dealer') }}</span>
                                                                <span class="dealer-name">{{ html_decode($dealer?->name) }}</span>
                                                                <span class="listing-warranty">3 Month Warranty</span>
                                                            </div>
                                                        @else
                                                            <div class="listing-price-meta">
                                                                <span class="private-name">{{ __('translate.Private') }}</span>
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
