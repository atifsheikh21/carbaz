...
<style>
    ...
    .forum-owner-actions{display:flex;align-items:center;gap:8px;margin:-4px 0 14px}.forum-owner-actions form{margin:0}.forum-owner-actions a,.forum-owner-actions button{min-height:34px;display:inline-flex;align-items:center;justify-content:center;padding:0 13px;border:1px solid #E5E7EB;border-radius:999px;background:#fff;color:#374151;font-size:13px;font-weight:700;text-decoration:none;cursor:pointer}.forum-owner-actions button{border-color:#fca5a5;color:#dc2626}.forum-owner-actions button:hover{background:#fef2f2}.forum-owner-actions a:hover{border-color:#4B5563;color:#111827}
</style>
@endpush
