                        ...
                        <article class="forum-post-card">
                            ...
                            @if($item->image)
                                <a href="{{ route('car-part-requests.show', $item->id) }}" class="forum-card-image">
                                    <img src="{{ getImageOrPlaceholder($item->image, '720x360') }}" alt="{{ $item->title }}">
                                </a>
                            @endif
...
<style>
    ...
    .forum-owner-actions{display:inline-flex!important;align-items:center;gap:8px;margin:-2px 0 14px;white-space:nowrap}.forum-owner-actions form{display:inline-flex!important;margin:0}.forum-owner-actions a,.forum-owner-actions button{width:auto!important;min-height:32px;display:inline-flex;align-items:center;justify-content:center;padding:0 14px;border:1px solid #D1D5DB;border-radius:999px;background:#fff;color:#374151;font-size:13px;font-weight:800;line-height:1;text-decoration:none;cursor:pointer}.forum-owner-actions button{border-color:#fca5a5;color:#dc2626}.forum-owner-actions button:hover{background:#fef2f2}.forum-owner-actions a:hover{border-color:#4B5563;color:#111827}.forum-card-category{display:inline-flex;align-items:center;min-height:24px;padding:0 10px;border-radius:999px;background:#eef2ff;color:#3730a3;font-size:12px;font-weight:800;margin:0 0 8px}.forum-card-image{display:block;margin:10px 0 12px;border-radius:8px;overflow:hidden;background:#F3F4F6;border:1px solid #E5E7EB}.forum-card-image img{display:block;width:100%;aspect-ratio:2/1;object-fit:cover}.forum-post-card .forum-card-title{font-size:22px;line-height:1.25;font-weight:850;color:#111827;margin:2px 0 6px}.forum-post-card>p{font-size:15px;line-height:1.65;color:#6B7280;margin:0 0 14px}
</style>
@endpush
